                        ...
                        <div className="p-6">
                            ...
                            <div className="mt-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                                {filteredTemplates.map((template) => (
                                    <div
                                        key={template.id}
                                        className="border border-gray-600 rounded-lg p-4 hover:shadow-lg bg-slate-700/50 transition-shadow"
                                    >
                            ...
                            {showModal && (
                                <div className="fixed inset-0 bg-black/70 flex items-center justify-center z-50">
                                    <div className="bg-slate-800 border border-white/10 rounded-lg p-6 w-full max-w-2xl max-h-[90vh] overflow-y-auto">
                                        ...
                                        <div className="mt-6 flex justify-end gap-3">
                                            <button
                                                ...
                                                className="px-4 py-2 bg-slate-700 text-gray-200 rounded-md hover:bg-slate-600 transition-colors"
                                            >
                                                Annuler
                                            </button>
                                            <button
